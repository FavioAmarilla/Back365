Public Class FrmVistaStkAlmacenes
    ...
    Dim frmRptExistenciaPorAlmacenes As FrmRptExistenciaPorAlmacenes

    Private Sub FrmVistaStkAlmacenes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        listarTransacciones()
    End Sub
    ...
    Public Sub seFrmTraspasoProductosSuc(frm As FrmTraspasoProductosSuc, activo As String)
        frmTraspasoProductosSuc = frm
        frmActivo = activo
    End Sub


    Public Sub seFrmRptExistenciaPorAlmacenes(frm As FrmRptExistenciaPorAlmacenes, activo As String)
    ...
    Sub listarTransacciones()
        ...
        dtTransacciones = contTransacciones.consultar("SELECT IDENTIFICADOR, DESCRIPCION FROM STK_ALMACENES")
    ...
    Sub enviarID(id As String)
        If frmActivo = "FrmConsumoMateriaPrima" Then
            frmConsumoMateriaPrima.getAlmacen(id)
        End If
        If frmActivo = "FrmTraspasoProductosSucALD" Then
            frmTraspasoProductosSuc.getAlmacen(id, "FrmTraspasoProductosSucALD")
        End If
        If frmActivo = "FrmTraspasoProductosSucALO" Then
            frmTraspasoProductosSuc.getAlmacen(id, "FrmTraspasoProductosSucALO")
        End If
        If frmActivo = "FrmRptExistenciaPorAlmacenes" Then
            frmRptExistenciaPorAlmacenes.getAlmacen(id)
        End If
