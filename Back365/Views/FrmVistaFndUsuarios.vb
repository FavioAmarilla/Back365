Public Class FrmVistaFndUsuarios
    ...
    Private Sub FrmVistaFndUsuarios_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        listarSitios()
    End Sub
    ...
    Sub listarSitios()
        dtSitios = contFndUsuarios.consultar("SELECT IDENTIFICADOR, NOMBRE FROM FND_USUARIOS ORDER BY NOMBRE ASC")
    ...
    Sub enviarID(id As String)
        If frmActivo = "FrmAsignacionPermisosUsuario" Then
            frmAsignacionPermisosUsuario.getUsuario(id)
        End If
