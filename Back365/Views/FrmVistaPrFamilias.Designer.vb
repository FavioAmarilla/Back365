...
Partial Class FrmVistaPrFamilias
    ...
    Private Sub InitializeComponent()
        ...
        Me.gridFamilias = New DevExpress.XtraGrid.GridControl()
        Me.GridView1 = New DevExpress.XtraGrid.Views.Grid.GridView()
        Me.COL_IDENTIFICADO = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        CType(Me.gridFamilias, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.PanelControl1.Controls.Add(Me.gridFamilias)
        ...
        'gridFamilias
        '
        Me.gridFamilias.Location = New System.Drawing.Point(14, 74)
        Me.gridFamilias.MainView = Me.GridView1
        Me.gridFamilias.Name = "gridFamilias"
        Me.gridFamilias.RepositoryItems.AddRange(New DevExpress.XtraEditors.Repository.RepositoryItem() {Me.RepositoryItemTextEdit1})
        Me.gridFamilias.Size = New System.Drawing.Size(345, 353)
        Me.gridFamilias.TabIndex = 1
        Me.gridFamilias.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.GridView1})
        '
        'GridView1
        '
        ...
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.COL_IDENTIFICADO, Me.COL_DESCRIPCION})
        Me.GridView1.GridControl = Me.gridFamilias
        ...
        'COL_IDENTIFICADO
        '
        Me.COL_IDENTIFICADO.AppearanceCell.Options.UseTextOptions = True
        Me.COL_IDENTIFICADO.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Near
        Me.COL_IDENTIFICADO.AppearanceHeader.Options.UseTextOptions = True
        Me.COL_IDENTIFICADO.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Near
        Me.COL_IDENTIFICADO.Caption = "IDENTIFICADOR"
        Me.COL_IDENTIFICADO.ColumnEdit = Me.RepositoryItemTextEdit1
        Me.COL_IDENTIFICADO.FieldName = "IDENTIFICADOR"
        Me.COL_IDENTIFICADO.Name = "COL_IDENTIFICADO"
        Me.COL_IDENTIFICADO.Visible = True
        Me.COL_IDENTIFICADO.VisibleIndex = 0
        Me.COL_IDENTIFICADO.Width = 110
        '
        ...
        CType(Me.gridFamilias, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents gridFamilias As DevExpress.XtraGrid.GridControl
    Friend WithEvents GridView1 As DevExpress.XtraGrid.Views.Grid.GridView
    Friend WithEvents COL_IDENTIFICADO As DevExpress.XtraGrid.Columns.GridColumn
