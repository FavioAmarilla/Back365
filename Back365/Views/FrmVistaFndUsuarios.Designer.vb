...
Partial Class FrmVistaFndUsuarios
    ...
    Private Sub InitializeComponent()
        ...
        Me.gridUsuarios.RepositoryItems.AddRange(New DevExpress.XtraEditors.Repository.RepositoryItem() {Me.RepositoryItemTextEdit1})
