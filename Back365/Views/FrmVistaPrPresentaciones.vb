Public Class FrmVistaPrPresentaciones

    Dim contPresentacion As New ContPrPresentacion
    Dim dtPresentaciones As New DataTable
    Dim frmActivo As String = ""

    Private Sub FrmVistaPresentaciones_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub listarPresentaciones()
        ...
        dtPresentaciones = contPresentacion.consultar("SELECT IDENTIFICADOR, DESCRIPCION FROM PR_PRESENTACION")
    ...
    Sub enviarID(id As String)
        If frmActivo = "FrmActivarDesactivarProducto" Then
            FrmActivarDesactivarProducto.getPresentacion(id)
        End If
