Public Class FrmVistaAppPromocionesProv
    ...
    Private Sub FrmVistaAppPromocionesProv_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        listar()
    End Sub
    ...
    Sub listar()
        dt = controlador.consultar("SELECT IDENTIFICADOR, NOMBRE FROM APP_PROMOCIONES_PROV")
    ...
    Sub enviarID(id As String)
        If frmActivo = "FrmAppPromocionesProv" Then
            frmAppPromocionesProv.getPromocion(id)
        End If
