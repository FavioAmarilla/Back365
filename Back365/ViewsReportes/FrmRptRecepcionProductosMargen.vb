...
Public Class FrmRptRecepcionProductosMargen
    ...
    Private Sub FrmRptRecepcionProductosMargen_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub vistas(vr As String)
        ...
        If vr = "PR" Then
            ...
            frm.setFrmActivo("FrmRptRecepcionProductosMargen")
            frm.ShowDialog()
        End If
    ...
    Sub consultar()
        ...
        sql = "SELECT FECHA, NRO_FACTURA, NRO_RECEPCION, PROVEEDOR, CODIGO_BARRA, PRODUCTO, CANTIDAD, PRECIO_UNITARIO, 
                       COSTO, PORC_DESCUENTO, TOTAL, PRECIO_VENTA, ROUND((((PRECIO_VENTA / COSTO) * 100) - 100), 2) AS MARGEN
                FROM (
                            SELECT FECHA, NUMERO AS NRO_FACTURA, NRO_RECEPCION, PROVEEDOR, CODIGO_BARRA, PRODUCTO, CANTIDAD, PRECIO_UNITARIO,
                            CASE 
                            ...
                            FROM (
                                ...
                                COALESCE(IT.PORC_DESCUENTO, 0) AS PORC_DESCUENTO, PR_PRODUCTOS.PRECIO_VENTA
                                ...
                                WHERE CP_COMPROBANTES.ID_TIPO_COMPROB <> 3 AND STK_RECEPCIONES.VR_SITUACION='CO'" & desde & hasta & producto & proveedor & "
                            )
                    )"
    ...
    Private Sub btnImprimir_Click(sender As Object, e As EventArgs) Handles btnImprimir.Click
        ...
        Dim report As New RptRecepcionProductosMargen
