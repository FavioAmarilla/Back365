...
Partial Class FrmRptRecepcionProductos
    ...
    Private Sub InitializeComponent()
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.COL_FECHA, Me.COL_PROVEEDOR, Me.COL_NRO_FACTURA, Me.COL_NRO_RECEPCION, Me.COL_COD_BARRAS, Me.COL_PRODUCTO, Me.COL_CANTIDAD, Me.COL_PRECIO_UNITARIO, Me.COL_PORC_DESCUENTO, Me.COL_TOTAL, Me.COL_COSTO})
        ...
        Me.COL_PRECIO_UNITARIO.Width = 73
        '
        'rpsMiles
        '
        ...
        Me.COL_PORC_DESCUENTO.Width = 67
        '
        'rpsPorcentaje
        '
        ...
        Me.COL_TOTAL.VisibleIndex = 9
        Me.COL_TOTAL.Width = 78
        '
        'COL_COSTO
        '
